...
-   The transcriptome–proteome comparisons show that mRNA alone cannot capture this tuning, while the PCA across regions reveals that even at a global scale, protein expression maps neatly onto brain anatomy
...
See how different the cell types' expressions is
