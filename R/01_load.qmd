...
supp_17 <- readxl::read_xlsx("../data/_raw/EMS116660-supplement-Table_S17.xlsx", skip = 1)
```

# Creating loaded files with the data
...
write_tsv(supp_17, "../data/dirty_data/supp_17.tsv")
```
